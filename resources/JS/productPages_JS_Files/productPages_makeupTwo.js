...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_makeupTwo').style.backgroundImage = "url('" + newUrl + "')";
        document.getElementById('mag-overlay_makeupTwo').style.display = "none";
        document.getElementById('mag-overlay-two_makeupTwo').style.display = "none";
    };
}

// Makeup Two
document.getElementById('preview-img-one_makeupTwo').addEventListener('mouseover', setURL('/resources/images/makeup-img-two.jpg'));
document.getElementById('preview-img-two_makeupTwo').addEventListener('mouseover', setURL('/resources/images/makeup-img-two_paletteTwo.jpg'));
document.getElementById('preview-img-three_makeupTwo').addEventListener('mouseover', setURL('/resources/images/makeup-img-two_paletteOne.jpg'));
document.getElementById('preview-img-four_makeupTwo').addEventListener('mouseover', setURL('/resources/images/makeup-img-two_fingers.jpg'));
document.getElementById('preview-img-five_makeupTwo').addEventListener('mouseover', setURL('/resources/images/makeup-img-two_arm.jpg'));
...
function zoomIn(event) {
    ...
    var element = document.getElementById("mag-overlay_makeupTwo");
    element.style.display = "inline-block";
    element.style.backgroundPosition = posX + "% " + posY + "%";

    var element2 = document.getElementById("mag-overlay-two_makeupTwo");
    element2.style.display = "inline-block";
    element2.style.backgroundPosition = posX + "% " + posY + "%";
}

document.getElementById('mag-overlay_makeupTwo').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_makeupTwo() { // prevImgDecoyFunctionOne_makeupTwo
    // hides img-one and displays img-one-after
    document.getElementById("preview-img-one_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-one-after_makeupTwo").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-two-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-three-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-four-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-five-after_makeupTwo").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-two_makeupTwo").style.opacity = "1";
    document.getElementById("preview-img-three_makeupTwo").style.opacity = "1";
    document.getElementById("preview-img-four_makeupTwo").style.opacity = "1";
    document.getElementById("preview-img-five_makeupTwo").style.opacity = "1";
}
function prevImgDecoyFunctionTwo_makeupTwo() { // prevImgDecoyFunctionTwo_makeupTwo
    // hides img-two and displays img-two-after
    document.getElementById("preview-img-two_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-two-after_makeupTwo").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-three-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-four-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-five-after_makeupTwo").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-one_makeupTwo").style.opacity = "1";
    document.getElementById("preview-img-three_makeupTwo").style.opacity = "1";
    document.getElementById("preview-img-four_makeupTwo").style.opacity = "1";
    document.getElementById("preview-img-five_makeupTwo").style.opacity = "1";
}
function prevImgDecoyFunctionThree_makeupTwo() { // prevImgDecoyFunctionThree_makeupTwo
    // hides img-three and displays img-three-after
    document.getElementById("preview-img-three_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-three-after_makeupTwo").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-two-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-four-after_makeupTwo").style.opacity = "0";
...
function prevImgDecoyFunctionFour_makeupTwo() { // prevImgDecoyFunctionFour_makeupTwo
    // hides img-four and displays img-four-after
    document.getElementById("preview-img-four_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-four-after_makeupTwo").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-two-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-three-after_makeupTwo").style.opacity = "0";
...
function prevImgDecoyFunctionFive_makeupTwo() { // prevImgDecoyFunctionFive_makeupTwo
    // hides img-five and displays img-five-after
    document.getElementById("preview-img-five_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-five-after_makeupTwo").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-two-after_makeupTwo").style.opacity = "0";
    document.getElementById("preview-img-three-after_makeupTwo").style.opacity = "0";
