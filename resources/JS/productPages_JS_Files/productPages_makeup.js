...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_makeup').style.backgroundImage = "url('" + newUrl + "')";
...
// Makeup
document.getElementById('preview-img-one_makeup').addEventListener('mouseover', setURL('/resources/images/makeup-img.jpg'));
document.getElementById('preview-img-two_makeup').addEventListener('mouseover', setURL('/resources/images/makeup-img_eyeshadow.jpg'));
document.getElementById('preview-img-three_makeup').addEventListener('mouseover', setURL('/resources/images/makeup-img_foundation.jpg'));
document.getElementById('preview-img-four_makeup').addEventListener('mouseover', setURL('/resources/images/makeup-img_mascara.jpg'));
document.getElementById('preview-img-five_makeup').addEventListener('mouseover', setURL('/resources/images/makeup-img_lipstick.jpg'));
...
document.getElementById('mag-overlay_makeup').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_makeup() { // prevImgDecoyFunctionOne_makeup
...
function prevImgDecoyFunctionTwo_makeup() { // prevImgDecoyFunctionTwo_makeup
...
function prevImgDecoyFunctionThree_makeup() { // prevImgDecoyFunctionThree_makeup
...
function prevImgDecoyFunctionFour_makeup() { // prevImgDecoyFunctionFour_makeup
...
function prevImgDecoyFunctionFive_makeup() { // prevImgDecoyFunctionFive_makeup
