...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_auto').style.backgroundImage = "url('" + newUrl + "')";
        document.getElementById('mag-overlay_auto').style.display = "none";
        document.getElementById('mag-overlay-two_auto').style.display = "none";
    };
}
...
function zoomIn(event) {
    ...
    var element = document.getElementById("mag-overlay_auto");
    element.style.display = "inline-block";
    element.style.backgroundPosition = posX + "% " + posY + "%";

    var element2 = document.getElementById("mag-overlay-two_auto");
    element2.style.display = "inline-block";
    element2.style.backgroundPosition = posX + "% " + posY + "%";
}

document.getElementById('mag-overlay_auto').addEventListener('mousemove', zoomIn);
