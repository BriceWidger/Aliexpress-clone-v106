...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_car').style.backgroundImage = "url('" + newUrl + "')";
...
// Car
document.getElementById('preview-img-one_car').addEventListener('mouseover', setURL('/resources/images/rc-toy.jpg'));
document.getElementById('preview-img-two_car').addEventListener('mouseover', setURL('/resources/images/rc-toy_back.jpg'));
document.getElementById('preview-img-three_car').addEventListener('mouseover', setURL('/resources/images/rc-toy_batteries.jpg'));
document.getElementById('preview-img-four_car').addEventListener('mouseover', setURL('/resources/images/rc-toy_box.jpg'));
document.getElementById('preview-img-five_car').addEventListener('mouseover', setURL('/resources/images/rc-toy_carpet.jpg'));
...
document.getElementById('mag-overlay_car').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_car() { // prevImgDecoyFunctionOne_car
...
function prevImgDecoyFunctionTwo_car() { // prevImgDecoyFunctionTwo_car
...
function prevImgDecoyFunctionThree_car() { // prevImgDecoyFunctionThree_car
...
function prevImgDecoyFunctionFour_car() { // prevImgDecoyFunctionFour_car
...
function prevImgDecoyFunctionFive_car() { // prevImgDecoyFunctionFive_car
