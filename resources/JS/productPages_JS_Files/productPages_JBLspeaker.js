...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_jbl').style.backgroundImage = "url('" + newUrl + "')";
        document.getElementById('mag-overlay_jbl').style.display = "none";
        document.getElementById('mag-overlay-two_jbl').style.display = "none";
    };
}

// JBL Speaker
document.getElementById('preview-img-one_jbl').addEventListener('mouseover', setURL('/resources/images/JBLspeaker.jpg'));
document.getElementById('preview-img-two_jbl').addEventListener('mouseover', setURL('/resources/images/JBLspeaker_front.jpg'));
document.getElementById('preview-img-three_jbl').addEventListener('mouseover', setURL('/resources/images/JBLspeaker_left.jpg'));
document.getElementById('preview-img-four_jbl').addEventListener('mouseover', setURL('/resources/images/JBLspeaker_top.jpg'));
document.getElementById('preview-img-five_jbl').addEventListener('mouseover', setURL('/resources/images/JBLspeaker_bottom.jpg'));
...
function zoomIn(event) {
    ...
    var element = document.getElementById("mag-overlay_jbl");
    element.style.display = "inline-block";
    element.style.backgroundPosition = posX + "% " + posY + "%";

    var element2 = document.getElementById("mag-overlay-two_jbl");
    element2.style.display = "inline-block";
    element2.style.backgroundPosition = posX + "% " + posY + "%";
}

document.getElementById('mag-overlay_jbl').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_jbl() { // prevImgDecoyFunctionOne_jbl
    // hides img-one and displays img-one-after
    document.getElementById("preview-img-one_jbl").style.opacity = "0";
    document.getElementById("preview-img-one-after_jbl").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-two-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-three-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-four-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-five-after_jbl").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-two_jbl").style.opacity = "1";
    document.getElementById("preview-img-three_jbl").style.opacity = "1";
    document.getElementById("preview-img-four_jbl").style.opacity = "1";
    document.getElementById("preview-img-five_jbl").style.opacity = "1";
}
function prevImgDecoyFunctionTwo_jbl() { // prevImgDecoyFunctionTwo_jbl
    // hides img-two and displays img-two-after
    document.getElementById("preview-img-two_jbl").style.opacity = "0";
    document.getElementById("preview-img-two-after_jbl").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-three-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-four-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-five-after_jbl").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-one_jbl").style.opacity = "1";
    document.getElementById("preview-img-three_jbl").style.opacity = "1";
    document.getElementById("preview-img-four_jbl").style.opacity = "1";
    document.getElementById("preview-img-five_jbl").style.opacity = "1";
}
function prevImgDecoyFunctionThree_jbl() { // prevImgDecoyFunctionThree_jbl
    // hides img-three and displays img-three-after
    document.getElementById("preview-img-three_jbl").style.opacity = "0";
    document.getElementById("preview-img-three-after_jbl").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-two-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-four-after_jbl").style.opacity = "0";
...
function prevImgDecoyFunctionFour_jbl() { // prevImgDecoyFunctionFour_jbl
    // hides img-four and displays img-four-after
    document.getElementById("preview-img-four_jbl").style.opacity = "0";
    document.getElementById("preview-img-four-after_jbl").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-two-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-three-after_jbl").style.opacity = "0";
...
function prevImgDecoyFunctionFive_jbl() { // prevImgDecoyFunctionFive_jbl
    // hides img-five and displays img-five-after
    document.getElementById("preview-img-five_jbl").style.opacity = "0";
    document.getElementById("preview-img-five-after_jbl").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-two-after_jbl").style.opacity = "0";
    document.getElementById("preview-img-three-after_jbl").style.opacity = "0";
