...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_camera').style.backgroundImage = "url('" + newUrl + "')";
        document.getElementById('mag-overlay_camera').style.display = "none";
        document.getElementById('mag-overlay-two_camera').style.display = "none";
    };
}

// Camera
document.getElementById('preview-img-one_camera').addEventListener('mouseover', setURL('/resources/images/olympus-camera.jpg'));
document.getElementById('preview-img-two_camera').addEventListener('mouseover', setURL('/resources/images/olympus-camera_back.jpg'));
document.getElementById('preview-img-three_camera').addEventListener('mouseover', setURL('/resources/images/olympus-camera_cover.jpg'));
document.getElementById('preview-img-four_camera').addEventListener('mouseover', setURL('/resources/images/olympus-camera_shoulder.jpg'));
document.getElementById('preview-img-five_camera').addEventListener('mouseover', setURL('/resources/images/olympus-camera_face.jpg'));
...
function zoomIn(event) {
    ...
    var element = document.getElementById("mag-overlay_camera");
    element.style.display = "inline-block";
    element.style.backgroundPosition = posX + "% " + posY + "%";

    var element2 = document.getElementById("mag-overlay-two_camera");
    element2.style.display = "inline-block";
    element2.style.backgroundPosition = posX + "% " + posY + "%";
}

document.getElementById('mag-overlay_camera').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_camera() { // prevImgDecoyFunctionOne_camera
    // hides img-one and displays img-one-after
    document.getElementById("preview-img-one_camera").style.opacity = "0";
    document.getElementById("preview-img-one-after_camera").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-two-after_camera").style.opacity = "0";
    document.getElementById("preview-img-three-after_camera").style.opacity = "0";
    document.getElementById("preview-img-four-after_camera").style.opacity = "0";
    document.getElementById("preview-img-five-after_camera").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-two_camera").style.opacity = "1";
    document.getElementById("preview-img-three_camera").style.opacity = "1";
    document.getElementById("preview-img-four_camera").style.opacity = "1";
    document.getElementById("preview-img-five_camera").style.opacity = "1";
}
function prevImgDecoyFunctionTwo_camera() { // prevImgDecoyFunctionTwo_camera
    // hides img-two and displays img-two-after
    document.getElementById("preview-img-two_camera").style.opacity = "0";
    document.getElementById("preview-img-two-after_camera").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_camera").style.opacity = "0";
    document.getElementById("preview-img-three-after_camera").style.opacity = "0";
    document.getElementById("preview-img-four-after_camera").style.opacity = "0";
    document.getElementById("preview-img-five-after_camera").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-one_camera").style.opacity = "1";
    document.getElementById("preview-img-three_camera").style.opacity = "1";
    document.getElementById("preview-img-four_camera").style.opacity = "1";
    document.getElementById("preview-img-five_camera").style.opacity = "1";
}
function prevImgDecoyFunctionThree_camera() { // prevImgDecoyFunctionThree_camera
    // hides img-three and displays img-three-after
    document.getElementById("preview-img-three_camera").style.opacity = "0";
    document.getElementById("preview-img-three-after_camera").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_camera").style.opacity = "0";
    document.getElementById("preview-img-two-after_camera").style.opacity = "0";
    document.getElementById("preview-img-four-after_camera").style.opacity = "0";
...
function prevImgDecoyFunctionFour_camera() { // prevImgDecoyFunctionFour_camera
    // hides img-four and displays img-four-after
    document.getElementById("preview-img-four_camera").style.opacity = "0";
    document.getElementById("preview-img-four-after_camera").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_camera").style.opacity = "0";
    document.getElementById("preview-img-two-after_camera").style.opacity = "0";
    document.getElementById("preview-img-three-after_camera").style.opacity = "0";
...
function prevImgDecoyFunctionFive_camera() { // prevImgDecoyFunctionFive_camera
    // hides img-five and displays img-five-after
    document.getElementById("preview-img-five_camera").style.opacity = "0";
    document.getElementById("preview-img-five-after_camera").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_camera").style.opacity = "0";
    document.getElementById("preview-img-two-after_camera").style.opacity = "0";
    document.getElementById("preview-img-three-after_camera").style.opacity = "0";
