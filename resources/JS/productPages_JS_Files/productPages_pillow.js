...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_pillow').style.backgroundImage = "url('" + newUrl + "')";
        document.getElementById('mag-overlay_pillow').style.display = "none";
        document.getElementById('mag-overlay-two_pillow').style.display = "none";
    };
}

// Pillow
document.getElementById('preview-img-one_pillow').addEventListener('mouseover', setURL('/resources/images/pillow.jpg'));
document.getElementById('preview-img-two_pillow').addEventListener('mouseover', setURL('/resources/images/pillow_one.jpg'));
document.getElementById('preview-img-three_pillow').addEventListener('mouseover', setURL('/resources/images/pillow_side.jpg'));
document.getElementById('preview-img-four_pillow').addEventListener('mouseover', setURL('/resources/images/pillow_push.jpg'));
document.getElementById('preview-img-five_pillow').addEventListener('mouseover', setURL('/resources/images/pillow_details.jpg'));
...
function zoomIn(event) {
    ...
    var element = document.getElementById("mag-overlay_pillow");
    element.style.display = "inline-block";
    element.style.backgroundPosition = posX + "% " + posY + "%";

    var element2 = document.getElementById("mag-overlay-two_pillow");
    element2.style.display = "inline-block";
    element2.style.backgroundPosition = posX + "% " + posY + "%";
}

document.getElementById('mag-overlay_pillow').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_pillow() { // prevImgDecoyFunctionOne_pillow
    // hides img-one and displays img-one-after
    document.getElementById("preview-img-one_pillow").style.opacity = "0";
    document.getElementById("preview-img-one-after_pillow").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-two-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-three-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-four-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-five-after_pillow").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-two_pillow").style.opacity = "1";
    document.getElementById("preview-img-three_pillow").style.opacity = "1";
    document.getElementById("preview-img-four_pillow").style.opacity = "1";
    document.getElementById("preview-img-five_pillow").style.opacity = "1";
}
function prevImgDecoyFunctionTwo_pillow() { // prevImgDecoyFunctionTwo_pillow
    // hides img-two and displays img-two-after
    document.getElementById("preview-img-two_pillow").style.opacity = "0";
    document.getElementById("preview-img-two-after_pillow").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-three-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-four-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-five-after_pillow").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-one_pillow").style.opacity = "1";
    document.getElementById("preview-img-three_pillow").style.opacity = "1";
    document.getElementById("preview-img-four_pillow").style.opacity = "1";
    document.getElementById("preview-img-five_pillow").style.opacity = "1";
}
function prevImgDecoyFunctionThree_pillow() { // prevImgDecoyFunctionThree_pillow
    // hides img-three and displays img-three-after
    document.getElementById("preview-img-three_pillow").style.opacity = "0";
    document.getElementById("preview-img-three-after_pillow").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-two-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-four-after_pillow").style.opacity = "0";
...
function prevImgDecoyFunctionFour_pillow() { // prevImgDecoyFunctionFour_pillow
    // hides img-four and displays img-four-after
    document.getElementById("preview-img-four_pillow").style.opacity = "0";
    document.getElementById("preview-img-four-after_pillow").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-two-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-three-after_pillow").style.opacity = "0";
...
function prevImgDecoyFunctionFive_pillow() { // prevImgDecoyFunctionFive_pillow
    // hides img-five and displays img-five-after
    document.getElementById("preview-img-five_pillow").style.opacity = "0";
    document.getElementById("preview-img-five-after_pillow").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-two-after_pillow").style.opacity = "0";
    document.getElementById("preview-img-three-after_pillow").style.opacity = "0";
