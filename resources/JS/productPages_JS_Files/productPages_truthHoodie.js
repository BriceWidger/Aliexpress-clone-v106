...
function setURL(newUrl) {
    return function () {
        ...
        document.getElementById('mag-overlay_truth').style.backgroundImage = "url('" + newUrl + "')";
        document.getElementById('mag-overlay_truth').style.display = "none";
        document.getElementById('mag-overlay-two_truth').style.display = "none";
    };
}

// Truth Hoodie
document.getElementById('preview-img-one_truth').addEventListener('mouseover', setURL('/resources/images/truthhoodie.jpg'));
document.getElementById('preview-img-two_truth').addEventListener('mouseover', setURL('/resources/images/truthhoodie_back.jpg'));
document.getElementById('preview-img-three_truth').addEventListener('mouseover', setURL('/resources/images/truthhoodie_frontwhite.jpg'));
document.getElementById('preview-img-four_truth').addEventListener('mouseover', setURL('/resources/images/truthhoodie_backwhite.jpg'));
document.getElementById('preview-img-five_truth').addEventListener('mouseover', setURL('/resources/images/truthhoodie_zoom.png'));
...
function zoomIn(event) {
    ...
    var element = document.getElementById("mag-overlay_truth");
    element.style.display = "inline-block";
    element.style.backgroundPosition = posX + "% " + posY + "%";

    var element2 = document.getElementById("mag-overlay-two_truth");
    element2.style.display = "inline-block";
    element2.style.backgroundPosition = posX + "% " + posY + "%";
}

document.getElementById('mag-overlay_truth').addEventListener('mousemove', zoomIn);

function prevImgDecoyFunctionOne_truth() { // prevImgDecoyFunctionOne_truth
    // hides img-one and displays img-one-after
    document.getElementById("preview-img-one_truth").style.opacity = "0";
    document.getElementById("preview-img-one-after_truth").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-two-after_truth").style.opacity = "0";
    document.getElementById("preview-img-three-after_truth").style.opacity = "0";
    document.getElementById("preview-img-four-after_truth").style.opacity = "0";
    document.getElementById("preview-img-five-after_truth").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-two_truth").style.opacity = "1";
    document.getElementById("preview-img-three_truth").style.opacity = "1";
    document.getElementById("preview-img-four_truth").style.opacity = "1";
    document.getElementById("preview-img-five_truth").style.opacity = "1";
}
function prevImgDecoyFunctionTwo_truth() { // prevImgDecoyFunctionTwo_truth
    // hides img-two and displays img-two-after
    document.getElementById("preview-img-two_truth").style.opacity = "0";
    document.getElementById("preview-img-two-after_truth").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_truth").style.opacity = "0";
    document.getElementById("preview-img-three-after_truth").style.opacity = "0";
    document.getElementById("preview-img-four-after_truth").style.opacity = "0";
    document.getElementById("preview-img-five-after_truth").style.opacity = "0";
    // displays all remaining preview-imgs
    document.getElementById("preview-img-one_truth").style.opacity = "1";
    document.getElementById("preview-img-three_truth").style.opacity = "1";
    document.getElementById("preview-img-four_truth").style.opacity = "1";
    document.getElementById("preview-img-five_truth").style.opacity = "1";
}
function prevImgDecoyFunctionThree_truth() { // prevImgDecoyFunctionThree_truth
    // hides img-three and displays img-three-after
    document.getElementById("preview-img-three_truth").style.opacity = "0";
    document.getElementById("preview-img-three-after_truth").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_truth").style.opacity = "0";
    document.getElementById("preview-img-two-after_truth").style.opacity = "0";
    document.getElementById("preview-img-four-after_truth").style.opacity = "0";
...
function prevImgDecoyFunctionFour_truth() { // prevImgDecoyFunctionFour_truth
    // hides img-four and displays img-four-after
    document.getElementById("preview-img-four_truth").style.opacity = "0";
    document.getElementById("preview-img-four-after_truth").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_truth").style.opacity = "0";
    document.getElementById("preview-img-two-after_truth").style.opacity = "0";
    document.getElementById("preview-img-three-after_truth").style.opacity = "0";
...
function prevImgDecoyFunctionFive_truth() { // prevImgDecoyFunctionFive_truth
    // hides img-five and displays img-five-after
    document.getElementById("preview-img-five_truth").style.opacity = "0";
    document.getElementById("preview-img-five-after_truth").style.opacity = "1";
    // hides all remaining preview-img-afters
    document.getElementById("preview-img-one-after_truth").style.opacity = "0";
    document.getElementById("preview-img-two-after_truth").style.opacity = "0";
    document.getElementById("preview-img-three-after_truth").style.opacity = "0";
